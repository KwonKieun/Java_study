...
public class ListEx1 {
	...
	public static void main(String[] args) {
		...
		/* - list3는 List 인터페이스를 구현한 구현 클래스들의 객체 중 아무나 올 수 있음
		...
		/* indexOf(객체) : List, 리스트에 객체가 몇 번지에 있는지 알려줌. 없으면 -1
		 * 	- 동작 방식은 contains와 같음
		 * */
		...
		/* sort() : List, 람다식을 이용해서 정렬 기준을 정해주면 정해진 정렬 기준대로 리스트를 정렬
		...
		/* Collections.sort() : 리스트의 타입이 comparable 인터페이스를 구현한 구현 클래스인 경우 해당 기준을 이용하여 정렬
		 * */
