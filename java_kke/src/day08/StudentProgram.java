...
public class StudentProgram {
	...
	public static void main(String[] args) {
		...
		for(int i = 0; i < stds.length; i++) {
			stds[i] = new Student(); // *유의하기* 각 번지마다 학생 인스턴스를 만들어줘야 함.
		}
		// 학생 번호를 수정
		int count = 1;
		...
		do {
			...
			case 1:
				...
				break;
			case 2:
				// 주어진 학생 정보를 조회하는 기능을 구현하세요. : 메서드 생성
	...
	public static void printScore(Student []stds) {
		...
		System.out.println("1. 학생별조회");
		System.out.println("2. 과목별조회");
		System.out.println("--------------");
		System.out.print("메뉴 선택 : ");
