...
public class HomeworkEx3_A {
	...
	public static void main(String[] args) {
		...
		Member2 mem2 = new Member2("abc", "def", "abc@naver.com");
		mem2.print();
...
class Member2{
	...
	public Member2(String id, String pw, String email) {
		this.id = id;
		this.pw = pw;
		this.email = email;
	}

	public Member2(String id, String pw) {
		this.id = id;
		this.pw = pw;
	}
