...
- 조회(무비차트)
	...
	- 영화는 오늘을 기준으로 오늘 이후에 일정들을 예매한 내역을 가쥰으로 조회한다.
...
관리자 기능
    ...
    - 극장 관리
        ...
        - 극장은 지역, 이름, 상영관 정보, 주소, 총 관수를 입력하고, 총좌석수는 등록된 상영관에 맞게 계산이 된다
        - 지역은 등록된 지역 중 하나를 선택한다.
        - 상영관 정보는 극장 등록과 함께 등록하거나 극장 등록 후 등록할 수 있다.
    - 상영관 관리
		- 관리자는 상영관을 통해 등록/수정/삭제할 수 있다.
