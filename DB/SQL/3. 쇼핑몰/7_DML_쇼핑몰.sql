...
# 아이디가 ADMIN이고, 비번이 ADMIN, 이메일이 ADMIN@GMAIL.COM,
-- 번호가 010-0000-0000인 관리자가 회원가입했을 때 필요한 쿼리
INSERT INTO MEMBER
VALUES('ADMIN', 'ADMIN', 'ADMIN@GMAIL.COM', '010-0000-0000', 'ADMIN', 0);
...
코드 : CLO001, 제품명 : 모자, 	내용 : 멋있는 모자, 가격 : 10000, 카테고리 : 의류(3)
코드 : CLO002, 제품명 : 셔츠, 	내용 : 멋있는 셔츠, 가격 : 50000, 카테고리 : 의류(3)
코드 : FOO001, 제품명 : 만두, 	내용 : 맛있는 만두, 가격 : 10000, 카테고리 : 식품(4)
코드 : FOO002, 제품명 : 라면, 	내용 : 맛있는 라면, 가격 : 3000,  카테고리 : 식품(4)
코드 : CAR001, 제품명 : 방향제, 	내용 : 좋은 방향제, 가격 : 5000,  카테고리 : 자동차(5)
*/
...
('CLO001', '모자', 	'멋있는 모자', 10000, 3),
('CLO002', '셔츠', 	'멋있는 셔츠', 50000, 3),
('FOO001', '만두',	'맛있는 만두', 10000, 4),
('FOO002', '라면', 	'맛있는 라면', 3000,  4),
('CAR001', '방향제', 	'좋은 방향제', 5000,  5);
...
UPDATE BASKET
SET BA_AMOUNT = 3
WHERE BA_ME_ID = 'abc123' AND BA_PR_CODE = 'ELC001';

SELECT * FROM BASKET;

# abc123 회원이 키보드를 장바구니에 1개 담았을 때 실행되는 쿼리
INSERT INTO BASKET(BA_AMOUNT, BA_ME_ID, BA_PR_CODE)
VALUES(1, 'abc123', 'ELC002');

# abc123 회원이 장바구니에 담긴 모든 제품을 주문했을 때 실행되는 쿼리
...
DELETE FROM BASKET WHERE CART_NUM = 1;
DELETE FROM BASKET WHERE CART_NUM = 2;
